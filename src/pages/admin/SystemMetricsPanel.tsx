      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="bg-slate-900 border-slate-700/60">
          <CardContent className="p-3">
            ...
            <p className="text-lg font-mono font-bold text-white">{metrics.active_connections}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-slate-900 border-slate-700/60">
          <CardContent className="p-3">
            ...
            <p className="text-lg font-mono font-bold text-white">{metrics.api_response_time}</p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-300 uppercase font-bold">API Load</span>
            </div>
            <span className="text-[10px] font-mono text-slate-200">{connectionHealth.toFixed(0)}%</span>
          </div>
          <Progress value={connectionHealth} className="h-1 bg-slate-700/60" />
        </div>
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-300 uppercase font-bold">Error Rate</span>
            </div>
            <span className="text-[10px] font-mono text-red-400">{metrics.error_rate}%</span>
          </div>
          <Progress value={metrics.error_rate} className="h-1 bg-slate-700/60" />
        </div>
      </div>
      ...
      <div className="pt-4 border-t border-slate-700/60">
        <div className="flex items-center justify-between p-2 bg-slate-900/70 rounded-lg border border-slate-700/60">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-slate-300 uppercase font-bold">Database Status</span>
          </div>
